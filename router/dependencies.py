...
router = APIRouter(
  prefix='/dependencies',
  tags=['dependencies'],
  dependencies=[Depends(log)] # this will add depend to all
)
...
@router.post('/user')
#def create_user(name: str, email: str, password: str, account: Account = Depends(Account)): # Account can be added or removed.
